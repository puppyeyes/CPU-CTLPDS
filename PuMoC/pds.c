...
PDSTransition pdstrans_create (Name from_state, Name from_stack, Name to_state,	Name to_stack1, Name to_stack2, char *label, int prio)
{
...
void pdstrans_list_insert(PushdownSystem *pds, PDSTransition pt,DdNode *vars)
{
